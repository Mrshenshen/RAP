...
class RLHFDataset(Dataset, ImageProcessMixin):
    ...
    def __getitem__(self, index):
        ...
        # reasoning_str: str = row_dict[self.reasoning_key]
        # if len(reasoning_str) != 0:
        #     cut_length = int(len(reasoning_str) * 20 / 100)
        #     add_reasoning_str = reasoning_str[:cut_length]
        #     if self.format_prompt:
        #         #Question:\n
        #         prompt_str = prompt_str + " " + self.format_prompt.strip() +" "+ add_reasoning_str
        ...
        row_dict["raw_prompt_ids"] = self.tokenizer.encode(prompt, add_special_tokens=False, max_length=self.max_prompt_length, truncation=True)
